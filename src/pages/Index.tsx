...
const Index = () => {
  ...
  const scrollToSection = (sectionId: string) => {
    ...
    const targetPosition = Math.max(elementTop - APP_CONFIG.ui.headerOffset, 0);
        ...
        >
          <div className="container relative z-10 text-center animate-fade-in pt-20">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Building stronger communities through mental, physical, and financial wellness
              programs that transform challenges into opportunities.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                onClick={() =>
                  window.open(
                    APP_CONFIG.externalUrls.donationStripe,
                    "_blank",
                    "noopener,noreferrer"
                  )
                }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-primary mb-2">
                  {APP_CONFIG.impact.gymMemberships}
                </div>
                <div className="text-sm md:text-base font-medium text-muted-foreground">
                  Months of Gym Memberships Donated
                </div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-primary mb-2">
                  {APP_CONFIG.impact.communityPartners}
                </div>
                <div className="text-sm md:text-base font-medium text-muted-foreground">
                  Community Partners
                </div>
              ...
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-primary mb-2">
                  {APP_CONFIG.impact.livesTransformed}
                </div>
                <div className="text-sm md:text-base font-medium text-muted-foreground">
                  Lives Transformed
                </div>
        ...
        <section id="mission" className="py-24 md:py-28 px-6">
          <div className="container mx-auto text-center">
            ...
            <div className="text-base leading-relaxed max-w-4xl mx-auto mb-8 text-muted-foreground">
              <p>
                SOS Empowers individuals to overcome life's challenges through resilience, fitness,
                and community support. We are dedicated to turning adversity into strength by
                providing resources, education, and opportunities that inspire personal growth and
          ...
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-base md:text-lg max-w-3xl mx-auto text-muted-foreground">
                Comprehensive wellness programs designed to strengthen mind, body, and financial
                security.
              </p>
            </div>
              ...
              {programs.map((program, index) => (
                <Card key={index} className="bg-card text-left">
                  <CardContent className="p-6 md:p-8">
                    ...
                    <h3 className="text-2xl font-semibold mb-3 md:mb-4 text-primary">
                      {program.title}
                    </h3>
        ...
        <section id="founders" className="py-20 md:py-24 px-6 bg-background">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-base md:text-lg max-w-3xl mx-auto text-muted-foreground">
                Driven by personal experience and a shared vision of empowerment through fitness and
                community support.
              </p>
            </div>
        ...
        <section id="donate" className="py-20 md:py-28 px-6">
          <div className="container mx-auto text-center">
            ...
            <p className="text-sm md:text-base text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed">
              Your donation directly funds gym memberships, equipment, and programs that transform
              young lives. Every dollar makes an impact.
            </p>
              ...
              <Card className="rounded-[16px] pt-9 pb-7 px-6 shadow-[0_4px_16px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.2)] bg-[#FAFAFA] dark:bg-card border-[1.5px]">
                <div className="flex flex-col items-center">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://buy.stripe.com/dRm8wPdPX6lW48F0Esfbq00",
                        "_blank",
                        "noopener,noreferrer"
                      )
                    }
            ...
            <div className="text-center mt-6 md:mt-8 px-4">
              <p className="text-xs md:text-sm text-muted-foreground font-medium">
                Strength Over Struggle is a 501(c)(3) nonprofit organization. Your donations are
                tax-deductible.
              </p>
            </div>
          </div>
